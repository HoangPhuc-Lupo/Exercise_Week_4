...
class GridViewScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('GridView Gallery')),
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              childAspectRatio: 1, // item vuông
              shrinkWrap: true,
              physics: const NeverScrollableScrollPhysics(),
              children: [
                for (final label in items)
                  _GridItem(icon: Icons.image, label: label),
              ],
            ),
            ...
            GridView.extent(
              ...
              children: [
                for (final label in items)
                  _GridItem(icon: Icons.photo, label: label),
              ],
            ),
          ],
        ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Expanded(
            child: Center(
              child: Icon(icon, size: 40, color: Colors.teal.shade800),
            ),
          ),
